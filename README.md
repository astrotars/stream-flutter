...
Basic knowledge of [Node.js](https://nodejs.org/en/) (JavaScript), [Flutter](https://flutter.dev/) ([Dart](https://dart.dev/)), [Kotlin](https://kotlinlang.org/) is required to follow this tutorial. This code is intended to run locally on your machine. 
